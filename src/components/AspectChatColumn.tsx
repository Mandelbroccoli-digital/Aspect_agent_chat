...
import { MessageSquare, Sparkles, BarChart3, Loader as Loader2, ChevronDown, Wrench, Cpu, CircleCheck as CheckCircle2 } from 'lucide-react';
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-1 z-20 bg-slate-800 border border-slate-700 rounded-lg shadow-xl min-w-[240px] max-h-64 overflow-y-auto">
            ...
            {enabledModels.length === 0 && (
              <p className="px-3 py-2 text-xs text-slate-500">No models enabled</p>
            )}
          </div>
        </>
      )}
